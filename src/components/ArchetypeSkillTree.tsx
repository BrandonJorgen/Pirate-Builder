    ...
    <div className='archetype-skill-tree'>
        ...
        <div className='skill-tree' id='Ranger-Skill-Tree' data-show="0">
            ...
            <div className='ranger-skill-tree-buttons'>
                ...
                <SkillButton index={54} positionRow={'5'} positionColumn={'8'} buttonType={0} icon={'./icons/skill_Icons/Ranger/BearTrap_Icon.png'} startsDisabled={'0'} startsSelected={false} canBePressed={true} connectedButtons={[55, 56, 57]} connectedLines={[59, 60, 61]} choices={[]} choiceMemory={0} updateChoiceMemoryFunction={UpdateChoiceMemory} tooltipSortClass={'skill-tree'} tooltipSide={'bottom'} tooltipName={'Bear Trap'} tooltipCost={'15'} tooltipRange={'30m'} tooltipCooldown={'30s'} tooltipUseOrCast={''} tooltipCastTime={''} tooltipResource={'Mana'} tooltipDescription={'Spawn a Trap at the target location which arms 1 sec after. When triggered, the target takes damage and is Rooted for 2 secs.'} handleClick={handleClick} choiceMenuSide={''} />
                ...
                <SkillButton index={57} positionRow={'5'} positionColumn={'9'} buttonType={0} icon={'./icons/skill_Icons/Ranger/HuntoftheRaven_Icon.png'} startsDisabled={'1'} startsSelected={false} canBePressed={true} connectedButtons={[58, 62]} connectedLines={[62, 63]} choices={[]} choiceMemory={0} updateChoiceMemoryFunction={UpdateChoiceMemory} tooltipSortClass={'skill-tree'} tooltipSide={'bottom'} tooltipName={'Hunt of the Raven'} tooltipCost={''} tooltipRange={''} tooltipCooldown={''} tooltipUseOrCast={'toggle'} tooltipCastTime={''} tooltipResource={''} tooltipDescription={'Call forth the spirit of the raven, imbuing yourself with increased physical penetration. Only one Hunt may be active at a time.'} handleClick={handleClick} choiceMenuSide={''} />
                <SkillButton index={58} positionRow={'6'} positionColumn={'10'} buttonType={0} icon={'./icons/skill_Icons/Ranger/MarkoftheRaven_Icon.png'} startsDisabled={'1'} startsSelected={false} canBePressed={true} connectedButtons={[59]} connectedLines={[64]} choices={[]} choiceMemory={0} updateChoiceMemoryFunction={UpdateChoiceMemory} tooltipSortClass={'skill-tree'} tooltipSide={'bottom'} tooltipName={'Mark of the Raven'} tooltipCost={'10'} tooltipRange={'35m'} tooltipCooldown={'30s'} tooltipUseOrCast={''} tooltipCastTime={''} tooltipResource={'Mana'} tooltipDescription={"Marks the target, triggering up to 33% physical damage everytime the target is hit, scaling based on the targets missing health %."} handleClick={handleClick} choiceMenuSide={''} />
                <SkillButton index={59} positionRow={'6'} positionColumn={'11'} buttonType={0} icon={'./icons/skill_Icons/Ranger/Headshot_Icon.png'} startsDisabled={'1'} startsSelected={false} canBePressed={true} connectedButtons={[60, 61]} connectedLines={[65, 66]} choices={[]} choiceMemory={0} updateChoiceMemoryFunction={UpdateChoiceMemory} tooltipSortClass={'skill-tree'} tooltipSide={'bottom'} tooltipName={'Headshot'} tooltipCost={'10'} tooltipRange={'30m'} tooltipCooldown={'8s'} tooltipUseOrCast={''} tooltipCastTime={''} tooltipResource={'Mana'} tooltipDescription={'Deal 200% physical damage to target enemy. Deals 25% more damage to targets below 50% of their max health and applies 1 stack of Wounded to each 25% missing health of the target.'} handleClick={handleClick} choiceMenuSide={''} />
        ...
        <div className='skill-tree' id='Mage-Skill-Tree' data-show="0">
            ...
            <div className='mage-skill-tree-buttons'>
                ...
                <SkillConnection index={77} connectionType={0} styleLeft={'172px'} styleTop={'352px'} styleWidth={'75px'} styleRotation={'90'} />
                <SkillConnection index={78} connectionType={0} styleLeft={'134px'} styleTop={'200px'} styleWidth={'150px'} styleRotation={'90'} />
                <SkillConnection index={79} connectionType={2} styleLeft={'360px'} styleTop={'355px'} styleWidth={'240px'} styleRotation={'90'} />
                <SkillConnection index={80} connectionType={0} styleLeft={'330px'} styleTop={'475px'} styleWidth={'150px'} styleRotation={'0'} />
                <SkillConnection index={81} connectionType={0} styleLeft={'480px'} styleTop={'475px'} styleWidth={'150px'} styleRotation={'0'} />
                <SkillConnection index={82} connectionType={0} styleLeft={'584px'} styleTop={'380px'} styleWidth={'150px'} styleRotation={'90'} />
                <SkillConnection index={83} connectionType={0} styleLeft={'565px'} styleTop={'385px'} styleWidth={'155px'} styleRotation={'0'} />
                <SkillConnection index={84} connectionType={0} styleLeft={'494px'} styleTop={'310px'} styleWidth={'150px'} styleRotation={'90'} />
                <SkillConnection index={85} connectionType={0} styleLeft={'625px'} styleTop={'250px'} styleWidth={'250px'} styleRotation={'90'} />
                <SkillConnection index={86} connectionType={2} styleLeft={'759px'} styleTop={'395px'} styleWidth={'160px'} styleRotation={'90'} />
                <SkillConnection index={87} connectionType={0} styleLeft={'690px'} styleTop={'475px'} styleWidth={'150px'} styleRotation={'0'} />
                <SkillConnection index={88} connectionType={0} styleLeft={'840px'} styleTop={'475px'} styleWidth={'150px'} styleRotation={'0'} />
                <SkillConnection index={89} connectionType={0} styleLeft={'870px'} styleTop={'296px'} styleWidth={'300px'} styleRotation={'90'} />
                <SkillConnection index={90} connectionType={0} styleLeft={'925px'} styleTop={'386px'} styleWidth={'155px'} styleRotation={'0'} />
                <SkillConnection index={91} connectionType={0} styleLeft={'892px'} styleTop={'350px'} styleWidth={'75px'} styleRotation={'90'} />
                <SkillConnection index={92} connectionType={0} styleLeft={'892px'} styleTop={'250px'} styleWidth={'75px'} styleRotation={'90'} />
                

                <SkillButton index={76} positionRow={'6'} positionColumn={'4'} buttonType={0} icon={'./icons/skill_Icons/Mage/Fireball_Icon.png'} startsDisabled={'0'} startsSelected={false} canBePressed={true} connectedButtons={[77, 79, 80, 81, 103, 108]} connectedLines={[75, 76, 77, 79, 80]} choices={[]} choiceMemory={0} updateChoiceMemoryFunction={UpdateChoiceMemory} tooltipSortClass={'skill-tree'} tooltipSide={'bottom'} tooltipName={'Fireball'} tooltipCost={'15'} tooltipRange={'30m'} tooltipCooldown={'12s'} tooltipUseOrCast={'use'} tooltipCastTime={'0.7s'} tooltipResource={'Mana'} tooltipDescription={'Hurl a ball of fire toward your target, dealing 250% fire damage and applying Burning for 100% fire damage.'} handleClick={handleClick} choiceMenuSide={''} />
                <SkillButton index={77} positionRow={'4'} positionColumn={'3'} buttonType={0} icon={'./icons/skill_Icons/Mage/MagmaField_Icon.png'} startsDisabled={'1'} startsSelected={false} canBePressed={true} connectedButtons={[78]} connectedLines={[78]} choices={[]} choiceMemory={0} updateChoiceMemoryFunction={UpdateChoiceMemory} tooltipSortClass={'skill-tree'} tooltipSide={'bottom'} tooltipName={'Magma Field'} tooltipCost={'40'} tooltipRange={'30m'} tooltipCooldown={'25s'} tooltipUseOrCast={'use'} tooltipCastTime={'2.4s'} tooltipResource={'Mana'} tooltipDescription={'Erupts the earth at target location, forming a boiling pool of lava that deals 50% fire damage and applies Burning at 50% fire damage power every 2 seconds to enemies within the area. Lasts 8 seconds.'} handleClick={handleClick} choiceMenuSide={''} />
                ...
                <SkillButton index={106} positionRow={'5'} positionColumn={'14'} buttonType={0} icon={'./icons/skill_Icons/Mage/Blink_Icon.png'} startsDisabled={'1'} startsSelected={false} canBePressed={true} connectedButtons={[]} connectedLines={[]} choices={[]} choiceMemory={0} updateChoiceMemoryFunction={UpdateChoiceMemory} tooltipSortClass={'skill-tree'} tooltipSide={'bottom'} tooltipName={'Accelerative Blink'} tooltipCost={''} tooltipRange={''} tooltipCooldown={''} tooltipUseOrCast={''} tooltipCastTime={''} tooltipResource={''} tooltipDescription={"After casting Blink, your nex Fireball, Frostbolt, or Lightning Strike cast within 3 seconds casts instantly."} handleClick={handleClick} choiceMenuSide={''} />
                <SkillButton index={107} positionRow={'6'} positionColumn={'14'} buttonType={0} icon={'./icons/skill_Icons/Mage/Blink_Icon.png'} startsDisabled={'1'} startsSelected={false} canBePressed={true} connectedButtons={[]} connectedLines={[]} choices={[]} choiceMemory={0} updateChoiceMemoryFunction={UpdateChoiceMemory} tooltipSortClass={'skill-tree'} tooltipSide={'bottom'} tooltipName={'Unyielding Blink'} tooltipCost={''} tooltipRange={''} tooltipCooldown={''} tooltipUseOrCast={''} tooltipCastTime={''} tooltipResource={''} tooltipDescription={"Blink breaks all disabling effects on the caster."} handleClick={handleClick} choiceMenuSide={''} />
                <SkillButton index={108} positionRow={'8'} positionColumn={'8'} buttonType={3} icon={'./icons/skill_Icons/Mage/ThermalEqualibrium_Icon.png'} startsDisabled={'1'} startsSelected={false} canBePressed={true} connectedButtons={[]} connectedLines={[]} choices={[]} choiceMemory={0} updateChoiceMemoryFunction={UpdateChoiceMemory} tooltipSortClass={'skill-tree'} tooltipSide={'bottom'} tooltipName={'Thermal Equilibrium'} tooltipCost={''} tooltipRange={''} tooltipCooldown={''} tooltipUseOrCast={''} tooltipCastTime={''} tooltipResource={''} tooltipDescription={"Whenever you apply Frozen to a target, refresh the duration of your applied Conflagrating statuses on that target."} handleClick={handleClick} choiceMenuSide={''} />
            </div>
